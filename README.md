...
- [moongas-collection-demo](https://github.com/bretttolbert/moongas-collection-demo) [![CI](https://github.com/bretttolbert/moongas-collection-demo/actions/workflows/test.yml/badge.svg)](https://github.com/bretttolbert/moongas-collection-demo/actions/workflows/test.yml) - Example Moongas media collection (metadata only)
...
- [Flask-JSGlue](https://github.com/bretttolbert/Flask-JSGlue) [![Test](https://github.com/bretttolbert/Flask-JSGlue/actions/workflows/ci.yml/badge.svg)](https://github.com/bretttolbert/Flask-JSGlue/actions/workflows/test.yml) - Dependency of `moongas-py-mediaserver`
